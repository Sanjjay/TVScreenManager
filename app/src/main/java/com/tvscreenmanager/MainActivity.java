/*
 * Copyright (C) 2026 TVScreenManager
 *
...
public class MainActivity extends Activity {
    ...
    private RadioGroup rgKeyboardApps;
    ...
    private void initializeViews() {
        ...
        rgKeyboardApps =
                findViewById(R.id.rg_keyboard_apps);
        ...
        tvCurrentKeyboard =
                findViewById(R.id.tv_current_keyboard);
    ...
    private void updateUi() {
        ...
        // -----------------------------------------------------------
        // Current keyboard label
        // -----------------------------------------------------------

        updateCurrentKeyboardLabel();
    ...
    private void updateCurrentScreensaverLabel() {
        ...
        if (displayName.isEmpty()) {
            ...
            tvCurrentScreensaver.setText(
                    "Currently applied: None detected"
            );
    ...
    private void updateCurrentKeyboardLabel() {

        if (tvCurrentKeyboard == null) {
            return;
        }
        ...
        if (displayName.isEmpty()) {
            ...
            tvCurrentKeyboard.setText(
                    "Currently applied: None detected"
            );

            tvCurrentKeyboard.setTextColor(
                    0xFF8995A5
            );
    ...
    private void discoverAndPopulateKeyboards() {

        if (rgKeyboardApps == null) {
            return;
        }

        rgKeyboardApps.removeAllViews();

        if (inputMethodManager == null) {

            rgKeyboardApps.addView(
                    createEmptyListText(
                            "Keyboard detection is unavailable."
                    )
            );
        ...
        if (keyboards == null ||
            ...
            rgKeyboardApps.addView(
                    createEmptyListText(
                            "No compatible keyboards were found."
                    )
            );
        ...
        if (rgKeyboardApps.getChildCount() == 0) {
    ...
    private RadioButton createAppRow(
            String displayName,
            String packageName) {
    ...
    private TextView createEmptyListText(
            String message) {
    ...
    private void updateKeyboardRows() {
        ...
        for (int i = 0;
             i < rgKeyboardApps.getChildCount();
             i++) {

            View view =
                    rgKeyboardApps.getChildAt(i);
