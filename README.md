...
* **Windows:** Download [Platform-Tools]([https://android.com](https://developer.android.com/tools/releases/platform-tools#downloads), extract the zip, and open Command Prompt inside that folder.
